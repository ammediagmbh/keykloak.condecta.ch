...
hoistedDependencies:
  ...
  /@patternfly/react-tokens/4.94.7:
    '@patternfly/react-tokens': private
  /@rollup/plugin-commonjs/11.0.2(rollup@2.79.1):
    '@rollup/plugin-commonjs': private
  /@rollup/plugin-json/4.1.0(rollup@2.79.1):
    '@rollup/plugin-json': private
  /@rollup/plugin-node-resolve/7.1.3(rollup@2.79.1):
  ...
  /prop-types-extra/1.1.1(@pika/react@16.13.1):
  ...
  /randombytes/2.1.0:
    randombytes: private
  /react-dropzone/9.0.0(@pika/react@16.13.1):
    react-dropzone: private
  /react-is/16.13.1:
    react-is: private
  /react-router/4.3.1(@pika/react@16.13.1):
  ...
  /rimraf/3.0.2:
    rimraf: private
  /rollup-plugin-babel/4.4.0(@babel/core@7.23.0)(rollup@2.79.1):
    rollup-plugin-babel: private
  /rollup-plugin-terser/5.3.1(rollup@2.79.1):
...
pendingBuilds:
  ...
  - /@nicolo-ribaudo/chokidar-2/2.1.8-no-fsevents.3
  - /fsevents/2.3.3
prunedAt: Thu, 22 Feb 2024 16:09:52 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/mschmidt/Library/pnpm/store/v3
